...
/**
 * This is the item provider adapter for a {@link wfwps.IntegerConstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerConstantItemProvider extends ConstantItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WfwpsPackage.Literals.INTEGER_CONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((IntegerConstant)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IntegerConstant_type") :
			getString("_UI_IntegerConstant_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerConstant.class)) {
			case WfwpsPackage.INTEGER_CONSTANT__VALUE:
