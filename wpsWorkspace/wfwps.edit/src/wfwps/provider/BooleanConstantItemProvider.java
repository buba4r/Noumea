...
/**
 * This is the item provider adapter for a {@link wfwps.BooleanConstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanConstantItemProvider extends ConstantItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WfwpsPackage.Literals.BOOLEAN_CONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((BooleanConstant)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanConstant_type") :
			getString("_UI_BooleanConstant_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanConstant.class)) {
			case WfwpsPackage.BOOLEAN_CONSTANT__VALUE:
