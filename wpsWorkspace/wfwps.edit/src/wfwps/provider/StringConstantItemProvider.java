...
/**
 * This is the item provider adapter for a {@link wfwps.StringConstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringConstantItemProvider extends ConstantItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WfwpsPackage.Literals.STRING_CONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((StringConstant)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringConstant.class)) {
			case WfwpsPackage.STRING_CONSTANT__VALUE:
